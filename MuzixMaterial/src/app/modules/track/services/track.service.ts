...
export class TrackService {
  ...
  constructor(private http: HttpClient) {
    ...
    this.microServiceUrl = 'http://172.23.239.61:8080/api/v1/';
    // this.microServiceUrl = 'http://localhost:8085/api/v1/';
  }
  ...
  getAddedTracks() {
    console.log(this.microServiceUrl + 'tracks/track');
    // console.log(this.http.get(this.microServiceUrl + 'tracks'));
